...
if sys.platform == "darwin":
    install_requires.extend(
        ["pyobjc-core", "pyobjc-framework-LaunchServices",]
    )
...
=======
    ...
    zip_safe=False,
    install_requires=install_requires,
    entry_points={"console_scripts": ["zopeedit = collective.zopeedit.zopeedit:main",]},
    data_files=data_files(),
    windows=[
        {
            "script": os.path.join("collective", "zopeedit", "zopeedit.py"),
    ...
    options={
        "py2exe": {"packages": ["encodings", "Plugins", "win32com"]},
        "py2app": {"argv_emulation": True},
    },
)
>>>>>>> origin/master
